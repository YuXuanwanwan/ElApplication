...
public class UniverseLayout extends FrameLayout {
    // 屏幕宽高
    ...
    public UniverseLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public UniverseLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public UniverseLayout(Context context) {
        super(context);
        init(context);
    }
    ...
    private ViewDragHelper.Callback callback = new ViewDragHelper.Callback() {
        ...
        public int clampViewPositionVertical(View child, int top, int dy) {
            ...
            if (top > (screenHeight * preScale - screenHeight) / 2) {
                top = (int) (screenHeight * preScale - screenHeight) / 2;// 限制mainView可向下移动到的位置
            }
            return top;
        }
